...
tooling_install() {
    ...
    brew install railwaycat/emacsmacport/emacs-mac fd fzf gh hyperkey mas ripgrep rust sd koekeishiya/formulae/skhd koekeishiya/formulae/yabai zig || error_clean "Error installing tooling with Brew"
