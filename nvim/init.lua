...
require('lazy').setup({
  ...
  'tpope/vim-fugitive', -- Conveenient Access to Git Commands
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'bash', 'c', 'html', 'json', 'lua', 'markdown', 'typescript', 'vim', 'vimdoc', 'yaml', 'zig' },
        auto_install = true,
  ...
  { 'echasnovski/mini.indentscope', opts = { options = { try_as_border = true }, symbol = '│' } },
